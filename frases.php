...
<head>
  <meta charset="UTF-8">
    ...
    <!-- <link rel="stylesheet" href="css/style_ logout.css"> -->
    ...
    <main id="container-frases">
      <article>
        <div class="banner">
          ...
          <!-- CARDS transparentes-->
          <h1 class="texto-banner frase-banner">Frases e Verbos em japonês</h1>
        </div>
      </article>
      <aside class="cards-katakana">
        <section class="card-katakana">
          <!--Card 1-->
          <div class="card-body">
            <h2>Frases e Verbos</h2>
            <h2>フレーズと動詞</h2>
            <h2>fureezu to doushi</h2>
          </div>
        </section>
      </aside>

    <div class="img-frases">
      <img src="img/img-frases/dialogo-frases.png" alt="">
    </div>
      ...
      <!-- VERBO Vir e Chegar kimasu -->
       ...
       <section class="secao-frases secao-03-numeros frases-head">
        <div class="secao-numero-index secao-frases frase-topo">
          ...
          <p>1 Kimasu (来ます)</p>
          <p>
            <span class="branco">Verbo Vir e Chegar </span>
          </p>
          <p>
          ...
          <p>
            <span class="cinza"
              ><strong>Kimasu (来ます)</strong> É usado para descrever a ação de
              se mover em direção ao local onde o falante está, ou para
              expressar que alguém ou algo está chegando a um determinado
              local.</span
            >
          </p>
        </div>
      ...
      <section class="secao-pagina-frases">
        ...
        <!-- Play invertidos -->
          ...
          <p>
            <span class="azul"
              >先週日本に<span id="laranja">来ました</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >Eu <span id="laranja">vim</span> para o Japão na semana passada.</span
              ></strong
            >
          </p>
          <p><span class="rosa">せんしゅうにほんにきました</span></p>

          <p><span class="verde-lima">Senshuu Nihon ni kimashita</span></p>
        </div>
        ...
        <div class="secao-numero-index secao-verbo-fazer">
          ...
          <p>
            <span class="azul"
              >電車が今着<span id="laranja">きます</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >O trem  está <span id="laranja">chegando</span> agora.</span
              ></strong
            >
          </p>
          <p><span class="rosa">でんしゃがいまつきます</span></p>

          <p><span class="verde-lima">Densha ga ima tsukimasu</span></p>
        </div>
        ...
        <div class="secao-numero-index secao-verbo-fazer">
          ...
          <p>
            <span class="azul"
              > 注文はいつ<span id="laranja"> 届きますか？</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >Quando o pedido <span id="laranja">irá chegar?</span></span
              ></strong
            >
          </p>
          <p><span class="rosa">ちゅうもんはいつ<span id="laranja">とどきますか？</span></span></p>

          <p><span class="verde-lima">Chuumon wa itsu <span id="laranja">todokimasu ka?</span></span></p>
        </div>
        ...
        <div class="secao-numero-index secao-verbo-fazer">
          ...
          <p>
            <span class="azul"
              >先生がもうすぐ<span id="laranja">来ます</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >O professor vai <span id="laranja">chegar</span>  em breve.</span
              ></strong
            >
          </p>
          <p><span class="rosa">せんせいがもうすぐきます</span></p>

          <p><span class="verde-lima">Sensei ga mousugu kimasu</span></p>
        </div>
        ...
        <div class="secao-numero-index secao-verbo-fazer">
          ...
          <p>
            <span class="azul"
              >明日友達が家に<span id="laranja">来ます</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >Meu  amigo vai <span id="laranja">vir</span> pra minha casa amanhã.</span
              ></strong
            >
          </p>
          <p><span class="rosa">あしたともだちがいえにきます</span></p>

          <p><span class="verde-lima">Ashita tomodachi ga ie ni kimasu</span></p>
        </div>
        ...
        <div class="secao-numero-index secao-verbo-fazer">
          ...
          <p>
            <span class="azul"
              >地下鉄は何時に着<span id="laranja">きますか？</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >A que horas o metrô <span id="laranja">chega?</span></span
              ></strong
            >
          </p>
          <p><span class="rosa">ちかてつは なんじに つきますか？</span></p>

          <p><span class="verde-lima">Chikatetsu wa nanji ni tsukimasu ka?</span></p>
        </div>
        ...
        <div class="secao-numero-index secao-verbo-fazer">
          ...
          <p>
            <span class="azul"
              >荷物はいつ<span id="laranja">着きますか？</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >Quando a bagagem vai <span id="laranja">chegar</span> ?</span
              ></strong
            >
          </p>
          <p><span class="rosa">にもつは いつ つきますか？</span></p>

          <p><span class="verde-lima">Nimotsu wa itsu tsukimasu ka?</span></p>
        </div>
        ...
        <div class="secao-numero-index secao-verbo-fazer">
          ...
          <p>
            <span class="azul"
              >電車がまもなく到着<span id="laranja">します</span></span
            >
          </p>
          <p>
            <strong
              ><span class="verde-fraco"
                >O  trem vai <span id="laranja">chegar</span> em breve.</span
              ></strong
            >
          </p>
          <p><span class="rosa">でんしゃが まもなく とうちゃくします</span></p>

          <p><span class="verde-lima">Densha ga mamonaku touchaku shimasu</span></p>
        </div>
      </section>
        ...
        <div class="grupo-1">
            ...
            <div class="box">
                ...
                <div class="rede-social">
                    <a href="#"><svg class="icone-face" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"></svg></a>
                    <a href="#"><svg class="icone-insta" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"></svg></a>
                    <a href="#"><svg class="icone-x" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"></svg></a>
                    <a href="#"><svg class="icone-you" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"></svg></a>
                </div>
            </div>
        </div>
        <div class="grupo-2">
            <small>&copy; 2023 <b>Nipoinside</b> - Todos os direitos reservados. Desenvolvido por [Augusto Ramos]</small>
        </div>
    </footer>

    <!-- SCRIPT PARA EXIBIR OPÇÃO SAIR -->
...
.close:focus {
    ...
    <script src="js/scriptFrases.js"></script>
