...
<main class="container">
        ...
        <div class="banner">
            ...
            <figure>
                ...
                <a href="kanji.html"><h1 class="texto-banner">日本語</a><br>
                    <p>にほんご</p><br>
            <!-- CARDS transparentes--> 
            <h1 class="texto-banner frase-banner">Alfabeto Hiragana</h1>
        </div>
    ...
    <!--  -->
                ...
                <div class="container-hiragana-p">
                    ...
                    <p>
                        ...
                        de uma consoante seguida por
                        uma vogal ou apenas uma vogal isolada.<b>(exceto a letra "n") (sua pronúncia é "un") </b>
                    </p>
                    <p>
                ...
                <img src="arquivos/tabela-hiragana.jpg" class="img-tabela-hira" alt="">
            <button class="download-button">
                ...
                <table class="tabela-hiragana">
                    <tr>
                        <th colspan="5">Alfabeto do Hiragana primeira parte da tabela</th>
                    </tr>
                    <tr>
                        <td>あ (a)</td>
                        <td>い (i)</td>
...
como <strong>"yōon" (拗音)</strong> e são usadas para criar sons adicionais na língua. Estas
 combinações são formadas ao adicionar pequenos caracteres "ya", "yu" ou "yo" às
  letras hiragana básicas correspondentes.
            ...
            <div id="tabela-combinacoes" class="hiragana-combinacoes">
                <table class="tabela-hiragana2">
                    <tr>
                ...
                <p>
                    ...
                    de que o <strong>hiragana</strong> é usado principalmente para palavras
                     nativas japonesas e partículas gramaticais, enquanto palavras
                      estrangeiras frequentemente são escritas com alfabeto <strong>katakana.</strong>
                </p>
                    <br>
                <p>
...
<div class="section-hiragana">
        ...
        <div class="botao-katakana">                 
                <a href="katakana.php">tabela katakana</a>
